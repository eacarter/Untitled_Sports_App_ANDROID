...
public class FriendsAdapter extends RecyclerView.Adapter<BindingViewholder> {
    ...
    @Inject
    public FriendsAdapter(Context context, DatabaseManager databaseManager, UserManager userManager, FragmentManager fragmentManager){
